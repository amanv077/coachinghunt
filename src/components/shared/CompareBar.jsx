...
export function CompareBar() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-[70] border-t-2 border-secondary/20 bg-white p-4 shadow-[0_-8px_30px_rgba(44,76,156,0.15)] md:bottom-4 md:mx-auto md:max-w-3xl md:rounded-2xl md:border md:border-secondary/20">
