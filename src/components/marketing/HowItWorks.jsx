...
const steps = [
  ...
  },
  {
    ...
    desc: "Check fees, batch timings, and authentic reviews in one place. Shortlist the coachings that actually fit your criteria.",
    icon: (
      <svg className="h-6 w-6 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2}>
  ...
  },
  {
    ...
    desc: "Pick a date and topic that fits your schedule. Get instant email & SMS confirmation with no agent callbacks.",
    icon: (
      <svg className="h-6 w-6 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2}>
